...
export default function Footer() {
  return (
    <>
      <div className="p-8 md:p-12 lg:p-16 my-8 md:my-12 bg-accent rounded-3xl">
        ...
        <div className="flex flex-col-reverse md:flex-row justify-between gap-3 body-text">
          ...
          <div className="flex justify-start items-start md:items-end flex-col text-right gap-0 md:gap-2 mt-4 mb-24 md:mb-0 md:mt-0">
            <a
              className="hover:text-light/40 w-fit h3"
              href="mailto:tirthjivani17@gmail.com?subject=Hey%20Tirth%20%3A)%20"
            >
              tirthjivani17@gmail.com
            </a>
            <a className="hover:text-light/40 w-fit h3" href="tel:09898219779">
              +91 98 98 219 779
            </a>
          </div>
        </div>
